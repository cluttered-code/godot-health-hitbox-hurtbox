...
class_name AbstractHurtBox3D extends Area3D
## [AbstractHurtBox3D] enables collision detection by [AbstractHitBox3D] or [AbstractHitScan3D] and applies affects to [Health].
