@tool
class_name BasicHurtBox3D extends AbstractHurtBox3D
## [BasicHurtBox3D] enables collision detection by [AbstractHitBox3D] or [AbstractHitScan3D] and applies affects to [Health].
