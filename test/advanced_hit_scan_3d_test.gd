class_name AdvancedHitScan3DTest extends GdUnitTestSuite
...
var hit_scan: AdvancedHitScan3D
...
func before_test() -> void:
	...
	hit_scan = auto_free(AdvancedHitScan3D.new())
	add_child(hit_scan)
...
func test_fire_hurt_box() -> void:
	hit_scan._test_collider = mock_hurt_box
...
func test_fire_hit_box() -> void:
	...
	hit_scan._test_collider = hit_box
